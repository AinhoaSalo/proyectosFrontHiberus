...
function textos(){
    ...
    document.write("slice 3: " + texto.slice(3,30) + "<br>");
    ...
    //split
    let datos = '14/07/2022'.split('/');
    document.write('día: ' + datos[0] + "<br>");
    document.write('día: ' + datos[1] + "<br>");
    document.write('día: ' + datos[2] + "<br>");
}
